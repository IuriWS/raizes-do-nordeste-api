...
- Restauração de estoque quando o pagamento é recusado ou o pedido é cancelado antes da conclusão do atendimento.
...
- Verificação técnica: `docs/verificacao-tecnica.md`.
...
- PDF técnico: `docs/pdf/relatorio-tecnico.pdf`.
...
O arquivo será gerado em `pacote/raizes-do-nordeste-api.zip`.

## Decisões técnicas

- O pagamento é mockado e não chama provedor externo.
- A criação do pedido reserva estoque imediatamente.
- Se o pagamento for recusado ou o pedido for cancelado antes da conclusão do atendimento, o estoque reservado é restaurado.
