...
$outputDir = Join-Path $root "entrega"
$stageDir = Join-Path $outputDir "raizes-do-nordeste-api"
$zipPath = Join-Path $outputDir "raizes-do-nordeste-api-entrega.zip"
...
$blockedNames = @("node_modules", "dist", ".tmp", "coverage", "entrega", "contratos")
