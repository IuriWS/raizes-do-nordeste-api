...
export class AuthController {
  ...
  @ApiUnauthorizedResponse({ description: 'Credenciais invalidas.', schema: { example: erroNaoAutorizadoExample } })
  @ApiUnprocessableEntityResponse({ description: 'Payload invalido.', schema: { example: erroValidacaoExample } })
  @HttpCode(200)
  @Post('login')
  ...
  @Public()
  @ApiOperation({ summary: 'Cria usuario e, quando aplicavel, cadastro de cliente.' })
  @ApiCreatedResponse({ description: 'Usuario cadastrado.', schema: { example: loginResponseExample.usuario } })
  @ApiUnprocessableEntityResponse({ description: 'Payload invalido.', schema: { example: erroValidacaoExample } })
  @Post('register')
