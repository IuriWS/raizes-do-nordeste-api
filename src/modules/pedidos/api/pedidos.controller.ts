...
export class PedidosController {
  ...
  @ApiForbiddenResponse({ description: 'Perfil sem permissao.', schema: { example: erroSemPermissaoExample } })
  @ApiNotFoundResponse({ description: 'Unidade, cardapio ou cliente nao encontrado.' })
  ...
  @ApiConflictResponse({ description: 'Pedido nao pode ser cancelado neste status.' })
  @Delete(':id/cancelar')
